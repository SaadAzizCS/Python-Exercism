...
class Alien:
    ...
    def __init__(self, x_coordinatep, y_coordinatep):
        self.x_coordinate = x_coordinatep
        self.y_coordinate = y_coordinatep
        self.health = 3
...
def new_aliens_collection(positions):
    ...
    for position in positions:
        returndata.append(Alien(position[0], position[1]))
    return returndata